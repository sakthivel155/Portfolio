...
function About() {
    return (
        <div className="bg-[#1E1E1F] border-[0.2px] border-[#353535] my-4 mb-16 rounded-xl p-4">
            ...
            <h3 className="my-2 text-lg">What I&apos;m Doing</h3>
        ...
        <div className="relative bg-gradient-to-br from-[hsl(0,0%,25%)] to-[hsla(0,0%,25%,0)]  rounded-lg p-[1px] my-5">
                  <div className="flex flex-col gap-5 items-center text-center p-3 bg-[#242324] rounded-lg ">
                    <img src={iconCode} alt="" className='w-12'/>
                   <div >
                   <h3 className='font-[poppins] mb-2'>Web development</h3>
                   <p className='text-sm text-justify'>I&apos;m proficient in HTML, CSS, and JavaScript with a solid understanding of basic concepts and syntax in React.js, enabling me to build engaging and functional frontend applications.</p>
                   </div> 
              </div>
        </div>
        </div>
