...
function Contact() {
    return (
        <div className="relative bg-[#1E1E1F] border-[0.2px] border-[#353535] my-4 rounded-xl p-5 mb-14 laptop:mb-0 desktop:m-0 desktop:w-full desktop:overflow-auto tablet:px-8 tablet:py-5">
            <LaptopNavbar/>
